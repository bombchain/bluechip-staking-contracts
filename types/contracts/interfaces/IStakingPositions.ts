...
export interface IStakingPositionsInterface extends utils.Interface {
  functions: {
...
export interface IStakingPositions extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IStakingPositionsInterface;
